...
- **Explosive Canisters** contain highly unstable exotic materials that detonate violently upon impact
- **Acid Gas Canisters** burst open to release a cloud of noxious corrosive gas that damages everything within it
- **Napalm Canisters** react with atmospheric oxygen to burn with intense heat
- **EMP Canisters** generate a powerful electromagnetic pulse that disables nearby bots
- **Grenades** explode after a few seconds when thrown
- **EMP Grenades** are similar to EMP canisters, but with a timed fuse
